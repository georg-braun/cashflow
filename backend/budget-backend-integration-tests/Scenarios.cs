...
public class Scenarios
{
    ...
    public Task RegularMonthSceanario()
    {
        ...
        //
        // // add cash stuff
        // await client.AddAccountEntryAsync(cashAccountId, 200, new DateTime(2022,3,2));
        // await client.AddAccountEntryAsync(cashAccountId, 100, new DateTime(2022,3,2));
        // await client.AddSpendingAsync(cashAccountId, groceriesBudgetId, 50, new DateTime(2022,3,10));
        // await client.AddAccountEntryAsync(cashAccountId, 50, new DateTime(2022,3,20));
        //
        // // add credit card stuff
        // await client.AddAccountEntryAsync(dkbAccountId, 1000, new DateTime(2022,3,2));
