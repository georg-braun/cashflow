...
public static class ChangesContainerDtoFactory
{
    ...
    private static ChangesContainerDto CreateContainer() => new ChangesContainerDto();
    ...
    {
        var container = CreateContainer();
        foreach (var moneyMovement in moneyMovements)
        {
            container.MoneyMovements.Add(moneyMovement.ToApiDto());
        }
        return container;
    ...
    public static ChangesContainerDto Create(IEnumerable<MoneyMovement> moneyMovements, IEnumerable<Category> categories)
    {
        var container = CreateContainer();
        foreach (var moneyMovement in moneyMovements)
        {
